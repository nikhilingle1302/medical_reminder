...
class ReminderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Determine if reminder is still active based on dates
    final isActive = _isActiveToday(reminder);
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${reminder.frequencyPerDay}x/day  •  $formattedTime',
                    style: TextStyle(
                      fontSize: 14.sp,
                  ...
                  // ✅ Show date range
                  Text(
                    '${reminder.startDate} → ${reminder.endDate ?? "ongoing"}',
                    style: TextStyle(
                      fontSize: 11.sp,
                      color: Colors.grey,
                    ),
            ...
            // ✅ No isTaken — show mark button always if active
            if (isActive)
              IconButton(
                icon: Icon(
  ...
  // ✅ Check if reminder is active today (between start and end date)
  bool _isActiveToday(Reminder reminder) {
    final today = DateFormat('yyyy-MM-dd').format(DateTime.now());
    final afterStart = reminder.startDate.compareTo(today) <= 0;
    final beforeEnd = reminder.endDate == null ||
